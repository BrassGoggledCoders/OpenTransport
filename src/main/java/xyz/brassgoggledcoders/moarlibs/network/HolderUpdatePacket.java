package xyz.brassgoggledcoders.moarlibs.network;
...
public class HolderUpdatePacket implements IMessage
{
	...
	public static class Handler implements IMessageHandler<HolderUpdatePacket, IMessage>
	{
		...
		{
			IThreadListener mainThread = MoarLibs.proxy.getIThreadListener(ctx);
	...
	{
		World world = MoarLibs.proxy.getWorld(messageContext);
		if(world != null)
		{
		...
		{
			MoarLibs.INSTANCE.getLogger().devInfo("The world was null");
		}
